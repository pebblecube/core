...
class project_screenshot
{
	...
	{
		return GLOBAL_SCREENSHOTS_URL."/".$project_id."/".$this->file_name;
	}
	...
	{
		return GLOBAL_WWW_FILE_PATH.GLOBAL_SCREENSHOTS_FOLDER.DIRECTORY_SEPARATOR.$project_id;
	}
